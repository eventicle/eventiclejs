...
========
[id="eventicle_eventiclejs_Saga_hotLaneParallelEventCount_member"]
...
========
[id="eventicle_eventiclejs_Saga_isHotPredicate_member"]
=== isHotPredicate
...
========
[id="eventicle_eventiclejs_Saga_withHotParallelEvents_member_1"]
...
========
[id="eventicle_eventiclejs_Saga_withHotPredicate_member_1"]
...
m|predicate
m|(event: xref:eventicle_eventiclejs_EventicleEvent_interface.adoc[EventicleEvent]) =&gt; Promise&lt;boolean&gt; \| boolean
|
