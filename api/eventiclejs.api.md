...
// @public
export function eventClientOnRedis(config: RedisStreamConfig): Promise<EventClient>;
...
// @public (undocumented)
export function shutdownAllAdapters(): Promise<void>;
...
//
// src/events/saga/index.ts:319:5 - (ae-forgotten-export) The symbol "StartHandlerConfig" needs to be exported by the entry point index.d.ts
// src/events/saga/index.ts:323:5 - (ae-forgotten-export) The symbol "HandlerConfig" needs to be exported by the entry point index.d.ts
